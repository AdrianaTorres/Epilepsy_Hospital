...
public class AdminCreate {
	...
	public AdminCreate() {
		...
		lblWelcomeAdminPlease.setFont(ui);
		label_2.setFont(ui);
		label_3.setFont(ui);
		
		lblWelcomeAdminPlease.setForeground(Color.BLACK);
		...
		btnConfirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				FileManager.createAdminFile(text_1.getText(), temp);
				f.dispose();
		...
		panel_1.add(lblWelcomeAdminPlease);
